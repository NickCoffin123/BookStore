...
import {getAllBooks, updateBook} from "../services/book.service.ts";
...
function Home() {
    ...
    return (
        <>
            ...
            {bookToEdit && (
                <EditBook book={bookToEdit} isOpen={isEditBookDialogOpen} onClose={handleOnClose} onSubmit={handleUpdateBook}/>
            )}
        </>
    );
}
